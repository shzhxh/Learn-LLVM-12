...
\begin{document}
	...
	\color{white}
	\section*{\zihao{1} 1 基于LLVM的编译器的基本构造}
	\pagecolor{mygray}
	\addcontentsline{toc}{section}{1 基于LLVM的编译器的基本构造}
	...
	\subsection*{\zihao{2} 第2章\hspace{0.5cm}浏览LLVM源码}
	\addcontentsline{toc}{subsection}{第2章\hspace{0.5cm}浏览LLVM源码}
	...
	\subfile{content/1/chapter3/0.tex}
		...
		\subsubsection*{\zihao{3} 词法分析}
		\addcontentsline{toc}{subsubsection}{词法分析}
		\subfile{content/1/chapter3/4.tex}
		\subsubsection*{\zihao{3} 句法分析}
		\addcontentsline{toc}{subsubsection}{句法分析}
